                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('pessoas.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nome" type="text" class="form-control" name="nome" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="idade" type="text" class="form-control" name="idade" value="{{ old('email') }}" required>
                                </div>
                            </div>
